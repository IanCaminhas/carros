...
class _LoginPageState extends State<LoginPage> {
  ...
  final GlobalKey<FormState> _formKey = GlobalKey<
      FormState>(); // permite criar funções para validar login e a senha
      ...
      child: ListView(
        children: <Widget>[
          ...
          TextFormField(
            ...
            obscureText: true,
            // para mostrar as bolinhas na senha
            style: TextStyle(color: Colors.blue, fontSize: 25),
            // design das letras do input
            decoration: InputDecoration(
                labelText: 'Senha',
                labelStyle: TextStyle(color: Colors.black, fontSize: 25.0),
                hintText:
          ...
          Container(
            ...
            margin: EdgeInsets.only(
                top: 20.0), // espaçamento de cima do input de senha e
            child: RaisedButton(
                color: Colors.blue,
                child: _progress
